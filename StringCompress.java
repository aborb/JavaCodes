 ...
 * example - the string 'aabcccccaaa' would become 'a2b1c5a3'. If the "compressed" string
 * does not become smaller than the original string, original string is returned.
 */
